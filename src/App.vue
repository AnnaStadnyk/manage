...
import TheTesimonial from '@/components/TheTesimonial.vue'
...
<template>
  ...
  >
    ...
    <TheBottom @show-contact="toogleContact"></TheBottom>
    <TheContact :show="isShown" @close-contact="toogleContact"></TheContact>
  </main>
