...
<template>
    <section class="mt-20 md:mt-24 2xl:mt-28 flex flex-col gap-8 xl:gap-10 justify-center items-center">
        ...
        <swiper-container init="false" ref="swiperEl" class="max-w-full">
            <swiper-slide v-for="(testimonial, i) in testimonials" :key="i" class="h-auto flex flex-col">
                <div class="mt-8 relative px-3.5 pb-3.5 pt-11 bg-primary-light flex flex-col gap-3.5 items-center rounded-sm flex-[1_1_100%]">
        ...
        <TheButton mode="brand" isShadow="true">Get Started</TheButton>
    </section>
</template>